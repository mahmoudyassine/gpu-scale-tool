...
const STUDIO_VERSION = '5.25.1', ENGINE_VERSION = 26;
...
/* ================= PUBLIC API & BOOT ================= */
window.GPUscale = {compute, gpuFitScan, sloOptScan, sloPrice, readState, serialize, applyConfig, buildXls, buildXlsxBytes, render, autoSize, computeProject, solvePool, sliceProfiles, MODELS, GPUS, QUANTS, CASES,
